/**
 * Bevor Objektinstanzen deklariert werden können --> Interface definieren
 */
interface ToDos {
    todosText: string;
...
function addTodo(): void {
    ...
    if (inputDOMElement.value != "") {
         ...
         * durch .unshift wird das neue Todo an den Anfang hinzugefügt
         */
        toDoList.unshift({
...
function deleteTodo(index: number): void {
     ...
     * Jetzt muss diese Stelle des Arrays gelöscht werden.
     */
